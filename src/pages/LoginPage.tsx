            ...
            <section className="min-h-screen flex items-stretch text-white">
                ...
                >
                    ...
                    <div className="w-full px-24 z-10">
                        <h1 className="text-5xl font-bold text-left tracking-wide mb-4">Compra Seguro</h1>
                ...
                <div
                    ...
                    <div className="w-full py-6 z-20">
                        ...
                        <div className="sm:w-2/3 w-full mx-auto bg-white/80 backdrop-blur-lg rounded-2xl p-8 shadow-xl border border-gray-100/50 hover:border-indigo-100/50 hover:bg-white/90 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
